...
<html>
  ...
  <nav id="mainNav" class="navbar navbar-default navbar-custom navbar-fixed-top">
      <div class="container">
          ...
          <div class="navbar-header page-scroll">
              ...
              <a class="navbar-brand page-scroll" href="#page-top">TrabaWHO</a>
          </div>
  ...
  <section id="result">
    ...
    <div class="col-lg-12 text-center">
        ...
        <h3 class="section-subheading text-muted">Which Career Pathway is right for you?</h3>
    </div>
</div>
      <div class="row">
        <div class="col-lg-6">
          <div class="col-lg-6">
          <center><img class="img-circle" src="data:image/gif;base64,R0lGODlhAQABAIAAAHd3dwAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw=="  width="140" height="140">
          <h2 style="margin-bottom:0px;margin-top:20px;font-weight:bold;font-size:35px;">Realistic</h2>
          ...
          <h2 style="margin-top: 0px;">Work</h2>
          <ul>
        ...
        <div class="col-lg-6">
          <div class="col-lg-6">
          <center><img class="img-circle" src="data:image/gif;base64,R0lGODlhAQABAIAAAHd3dwAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw=="  width="140" height="140">
          <h2 style="margin-bottom:0px;margin-top:20px;font-weight:bold;font-size:35px;">Investigative</h2>
        ...
        <div class="col-lg-6">
          <div class="col-lg-6">
          <center><img class="img-circle" src="data:image/gif;base64,R0lGODlhAQABAIAAAHd3dwAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw=="  width="140" height="140">
          <h2 style="margin-bottom:0px;margin-top:20px;font-weight:bold;font-size:35px;">Artistic</h2>
        ...
        <div class="col-lg-6">
          <div class="col-lg-6">
          <center><img class="img-circle" src="data:image/gif;base64,R0lGODlhAQABAIAAAHd3dwAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw=="  width="140" height="140">
          <h2 style="margin-bottom:0px;margin-top:20px;font-weight:bold;font-size:35px;">Social</h2>
    ...
    <div class="container marketing">
      <div class="row">
        <div class="col-lg-6">
          <div class="col-lg-6">
          <center><img class="img-circle" src="data:image/gif;base64,R0lGODlhAQABAIAAAHd3dwAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw=="  width="140" height="140">
          <h2 style="margin-bottom:0px;margin-top:20px;font-weight:bold;font-size:35px;">Enterprising</h2>
        ...
        <div class="col-lg-6">
          <div class="col-lg-6">
          <center><img class="img-circle" src="data:image/gif;base64,R0lGODlhAQABAIAAAHd3dwAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw=="  width="140" height="140">
          <h2 style="margin-bottom:0px;margin-top:20px;font-weight:bold;font-size:35px;">Conventional</h2>
