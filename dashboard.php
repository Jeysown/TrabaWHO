  ...
  <section id="team">
    ...
    <div class="container marketing" style="margin-top:20px;">
      <div class="row">
        ...
        <h3 class="section-subheading text-muted">An Awesome Group of People!</h3>
      </div>
      </div>
      <div class="row">
          <div class="col-sm-4">
              <div class="team-member">
                  <center><img src="assets/images/jason.jpg" class="img-responsive img-circle" alt=""></center>
                  <h4>Jason Lopez</h4>
                  <p class="text-muted">Lead Designer</p>
                  <p>I love burger, pizza, pasta, fries, and BATMAN!!</p>
          ...
          <div class="col-sm-4">
              <div class="team-member">
                  <center><img src="assets/images/joyce.jpg" class="img-responsive img-circle" alt=""></center>
                  <h4>Joyce Ann Potestades</h4>
                  <p class="text-muted">Android Developer</p>
                  <p>Wala e. Pogi talaga si Jason</p>
                  <ul class="list-inline social-buttons">
                      <li><a href="#"><i class="fa fa-twitter"></i></a>
                      </li>
                      <li><a href="#"><i class="fa fa-facebook"></i></a>
          ...
          <div class="col-sm-4">
              <div class="team-member">
                  <center><img src="assets/images/glen.jpg" class="img-responsive img-circle" alt=""></center>
                  <h4>Glenwin Bernabe</h4>
          ...
          <div class="col-lg-12" style="text-align:center;padding-top:20px;">
            <p class="text-muted" style="font-size:20px;font-style:italic">Anong kailangan? Magtulungan. Anong kailangan? Magtulungan! Anong kailangan? Magtulungan! Anong kailangan? Magtulungan! Anong kailangan? Magtulungan! Aba sabing magtulungan. Kulit mo. =))))</p>
          </div>
      </div>
    </div>
        </div>
